...
const GOOGLE_SHEET_URL = "https://script.google.com/macros/s/AKfycbyAwSUqAycIhmA7IPGJCKZ9KriCYw-Ll0kaLDs-Duw9TTLiu_SB-_RjVGpy7C0sBaM/exec";
...
const DEFAULT_CONTENT = {
  ...
  services: [
    { id:1, icon:"🏠", title:"Home Removals", desc:"Professional home moving service. We handle everything from packing to delivery with care and efficiency." },
    { id:2, icon:"🏢", title:"Office Removals", desc:"Minimize downtime with our efficient office relocation service. We work around your schedule." },
    { id:3, icon:"📦", title:"Packing Service", desc:"Full packing and unpacking service with high-quality materials to keep your belongings safe." },
    { id:4, icon:"🚛", title:"Transport & Delivery", desc:"Safe and reliable transport of furniture, appliances, and goods across Finland." },
    { id:5, icon:"🛋️", title:"Furniture Assembly", desc:"Professional assembly and disassembly of all types of furniture at your new location." },
    { id:6, icon:"🌍", title:"International Moving", desc:"Moving to or from Finland? We offer international relocation services across Europe." },
  ],
  about: {
        ...
        <div className="grid2" style={{ maxWidth:1100,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:isMobile?40:80 }}>
          <div>
            ...
            <div style={{ display:"flex",gap:12,marginTop:28 }}>
              <a href={content.company.facebook} target="_blank" rel="noreferrer" style={{ display:"flex",alignItems:"center",gap:8,padding:"10px 18px",background:"rgba(255,255,255,0.12)",color:"#fff",borderRadius:8,fontWeight:600,fontSize:14,border:"1px solid rgba(255,255,255,0.2)" }}>
              ...
              <a href={`https://wa.me/${content.company.whatsapp}`} target="_blank" rel="noreferrer" style={{ display:"flex",alignItems:"center",gap:8,padding:"10px 18px",background:"#25D366",color:"#fff",borderRadius:8,fontWeight:600,fontSize:14 }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="#fff"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/></svg>
                WhatsApp
              </a>
            </div>
          </div>
          <div style={{ background:"rgba(255,255,255,0.08)",borderRadius:16,padding:isMobile?20:32,border:"1px solid rgba(255,255,255,0.15)" }}>
            {["Full Name","Email Address","Phone Number"].map(p=>(
              <input key={p} placeholder={p} style={{ width:"100%",padding:"11px 13px",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:8,color:"#fff",fontSize:14,marginBottom:12,boxSizing:"border-box" }} />
            ))}
            <select style={{ width:"100%",padding:"11px 13px",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:8,color:"#fff",fontSize:14,marginBottom:12,boxSizing:"border-box" }}>
              <option value="">Select Service...</option>
              <option>Home Removal</option><option>Office Removal</option>
              <option>Packing Service</option><option>Transport & Delivery</option>
            </select>
            <textarea placeholder="Tell us about your move..." rows={3} style={{ width:"100%",padding:"11px 13px",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:8,color:"#fff",fontSize:14,marginBottom:12,resize:"vertical",boxSizing:"border-box",fontFamily:"inherit" }} />
            <button onClick={()=>setShowQuote(true)} style={{ width:"100%",padding:"14px",background:"#fff",color:BLUE,border:"none",borderRadius:10,fontWeight:800,fontSize:16,cursor:"pointer" }}>Send Request →</button>
          </div>
        </div>
      </section>
